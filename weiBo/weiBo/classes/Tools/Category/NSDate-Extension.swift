...
extension NSDate {
    class func createDateString(createAtStr : String) -> String {
        ...
        // 5.6.处理一年之内: 02-22 12:22 Set<Calendar.Component>
        let unitFlag = Set<Calendar.Component>([.year])
        let cmps = calendar.dateComponents(unitFlag, from: createDate, to: nowDate as Date)
